 ...
 * Medicos.java
 *
 * Created on 23 de noviembre de 2007, 02:18
 * Copyright seba
 */
 ...
 */
public class Medicos extends AbstractPageBean {
    ...
    private Listbox lbxMedicos = new Listbox();

    public Listbox getLbxMedicos() {
        return lbxMedicos;
    }

    public void setLbxMedicos(Listbox l) {
        this.lbxMedicos = l;
    }

    private Button btnAnadir = new Button();

    public Button getBtnAnadir() {
        return btnAnadir;
    }

    public void setBtnAnadir(Button b) {
        this.btnAnadir = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("Medicos Initialization Failure", e);
