 ...
 * BuscarPaciente.java
 *
 * Created on 23 de noviembre de 2007, 02:41
 * Copyright seba
 */
 ...
 */
public class BuscarPaciente extends AbstractPageBean {
    ...
    public void setBody1(Body btnDetalles) {
        this.body1 = btnDetalles;
    }
    ...
    public void setBtnAceptar(Button btnDetalles) {
        this.btnAceptar = btnDetalles;
    }
    ...
    private Listbox lbxCoincidentes = new Listbox();

    public Listbox getLbxCoincidentes() {
        return lbxCoincidentes;
    }

    public void setLbxCoincidentes(Listbox l) {
        this.lbxCoincidentes = l;
    }

    private Button btnDetalles = new Button();
    ...
    private StaticText lblCoincidentes = new StaticText();

    public StaticText getLblCoincidentes() {
        return lblCoincidentes;
    }

    public void setLblCoincidentes(StaticText st) {
        this.lblCoincidentes = st;
    }

    private DefaultOptionsList lbxCoincidentesDefaultOptions = new DefaultOptionsList();

    public DefaultOptionsList getLbxCoincidentesDefaultOptions() {
        return lbxCoincidentesDefaultOptions;
    }

    public void setLbxCoincidentesDefaultOptions(DefaultOptionsList dol) {
        this.lbxCoincidentesDefaultOptions = dol;
    }
    ...
    public void setBtnBuscar(Button btnDetalles) {
        this.btnBuscar = btnDetalles;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("BuscarPaciente Initialization Failure", e);
